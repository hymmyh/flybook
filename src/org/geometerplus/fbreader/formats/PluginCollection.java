...
import org.geometerplus.fbreader.formats.chm.ChmPlugin;
...
import org.geometerplus.fbreader.formats.umd.UmdPlugin;
...
public class PluginCollection {
	...
	public static PluginCollection Instance() {
		if (ourInstance == null) {
			...
			ourInstance.myPlugins.add(new HtmlPlugin());//hym 
			ourInstance.myPlugins.add(new TxtPlugin());//hym
			ourInstance.myPlugins.add(new UmdPlugin());//hym
			...
			ourInstance.myPlugins.add(new ChmPlugin());//hym
