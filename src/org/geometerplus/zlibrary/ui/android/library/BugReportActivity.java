...
//hym changer
		...
		reportTextView.append("FlyBook " + versionName + " has been crached, sorry. You can help to fix this bug by sending the report below to FBReader developers. The report will be sent by e-mail. Thank you in advance!\n\n");
		...
		findViewById(R.id.send_report).setOnClickListener(
			new View.OnClickListener() {
				public void onClick(View view) {
					...
					sendIntent.putExtra(Intent.EXTRA_EMAIL, new String[] { "hymmyh@gmail.com" });
					sendIntent.putExtra(Intent.EXTRA_TEXT, stackTrace);
					sendIntent.putExtra(Intent.EXTRA_SUBJECT, "FlyBook " + versionName + " exception report");
