...
package org.geometerplus.zlibrary.ui.androidfly.view;
...
//		System.out.println("--21u13t4-jjj--3-3----hym-----bug"+myTextPaint.getTextSize());
	...
	public int imageHeight(ZLImageData imageData) {
		Bitmap bitmap = ((ZLAndroidImageData)imageData).getBitmap(myWidth, myHeight);
//		System.out.println("----hym create bmp---"+myWidth+"-"+myHeight);
//		System.out.println("----hym create image to bmp---"+bitmap.getHeight());
		return ((bitmap != null) && !bitmap.isRecycled())  ? bitmap.getHeight() : 0;
	}

	public void drawImage(int x, int y, ZLImageData imageData) {
//		System.out.println("----hym draw bmp-x--"+x);
		Bitmap bitmap = ((ZLAndroidImageData)imageData).getBitmap(myWidth, myHeight);
