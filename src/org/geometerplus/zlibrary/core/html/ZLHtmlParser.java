...
final class ZLHtmlParser {
	...
	private final InputStreamReader myStream;

	public ZLHtmlParser(ZLHtmlReader htmlReader, InputStreamReader stream) throws IOException {
		myReader = htmlReader;
		myStream = stream;
	}
...
mainSwitchLabel:	
	...
	private static void processFullTag(ZLHtmlReader htmlReader, ZLCharBuffer tagName, int offset, ZLHtmlAttributeMap attributes) {
	...
	private static void processStartTag(ZLHtmlReader htmlReader, ZLCharBuffer tagName, int offset, ZLHtmlAttributeMap attributes) {
		htmlReader.startElementHandler(tagName.toString(), offset, attributes);
		attributes.clear();
	}

	private static void processEndTag(ZLHtmlReader htmlReader, ZLCharBuffer tagName) {
